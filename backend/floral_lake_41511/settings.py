"""
Django settings for floral_lake_41511 project.
...
ROOT_URLCONF = 'floral_lake_41511.urls'
...
WSGI_APPLICATION = 'floral_lake_41511.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_lake_41511 API",
    "DESCRIPTION": "API documentation for floral_lake_41511 App",
    "VERSION": "v1",
}
